...
<div class="w3-top">
    <ul class="w3-navbar w3-theme-d2 w3-left-align w3-large">
        ...
        <li class="w3-hide-small w3-right"><a href="#" class="w3-padding-large w3-hover-white" title="My Account"><img src="image/avatar2.png" class="w3-circle" style="height:25px;width:25px" alt="Avatar"></a></li>
    </ul>
</div>
        ...
        <div class="w3-col m3">
            ...
            <div class="w3-card-2 w3-round w3-white">
                <div class="w3-container">
                    ...
                    <p class="w3-center"><img src="image/avatar2.png" class="w3-circle" style="height:106px;width:106px" alt="Avatar"></p>
                    <hr>
